...
export interface NodeTypeResolver<TParent = any> {
  ...
  has_codebox?: NodeToHas_codeboxResolver<TParent>;
  has_image?: NodeToHas_imageResolver<TParent>;
  has_table?: NodeToHas_tableResolver<TParent>;
...
export interface NodeToHas_codeboxResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}

export interface NodeToHas_imageResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}

export interface NodeToHas_tableResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface DocumentMutationToUploadLinkResolver<TParent = any, TResult = any> {
  (parent: TParent, args: DocumentMutationToUploadLinkArgs, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface NodeMutationToMetaResolver<TParent = any, TResult = any> {
  (parent: TParent, args: NodeMutationToMetaArgs, context: any, info: GraphQLResolveInfo): TResult;
}
...
export interface DocumentSubscriptionToDocumentIdResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}

export interface DocumentSubscriptionToDocumentNameResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}

export interface DocumentSubscriptionToEventTypeResolver<TParent = any, TResult = any> {
  (parent: TParent, args: {}, context: any, info: GraphQLResolveInfo): TResult;
}
