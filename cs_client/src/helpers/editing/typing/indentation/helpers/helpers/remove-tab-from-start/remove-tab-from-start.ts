import { deleteSubDDOEsThatStartWithSpaceAndGetTheirText } from '::helpers/editing/typing/indentation/helpers/helpers/remove-tab-from-start/helpers/delete-sub-ddoes';
