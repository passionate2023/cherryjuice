...
// const handleResize = addedDismissibleClass => {
//   if (!addedDismissibleClass.current && window.innerWidth <= 850) {
//     document
//       .querySelector('.mdc-drawer')
//       .classList.add('mdc-drawer--dismissible');
//     const drawerScrim: HTMLDivElement = document.querySelector('#drawer-scrim');
//     if (drawerScrim) {
//       drawerScrim.style.display = document
//         .querySelector('.mdc-drawer')
//         .classList.contains('mdc-drawer--open')
//         ? 'inline'
//         : 'none';
//     }
//     addedDismissibleClass.current = true;
//   } else if (addedDismissibleClass.current && window.innerWidth > 850) {
//     document
//       .querySelector('.mdc-drawer')
//       .classList.remove('mdc-drawer--dismissible');
//     const drawerScrim: HTMLDivElement = document.querySelector('#drawer-scrim');
//     if (drawerScrim) {
//       drawerScrim.style.display = 'none';
//     }
//     addedDismissibleClass.current = false;
//   }
// };
