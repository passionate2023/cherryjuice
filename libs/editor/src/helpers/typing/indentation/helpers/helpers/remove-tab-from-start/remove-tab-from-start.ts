import { deleteSubDDOEsThatStartWithSpaceAndGetTheirText } from '::helpers/typing/indentation/helpers/helpers/remove-tab-from-start/helpers/delete-sub-ddoes';
import { removeTabFromStringStart } from '::helpers/typing/indentation/helpers/helpers/remove-tab-from-start/helpers/remove-tab-from-string-start/remove-tab-from-string-start';
