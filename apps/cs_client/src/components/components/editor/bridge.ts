...
export const bridge: Bridge = {
  current: {
    onPasteImageErrorHandler: undefined,
    onPasteErrorHandler: undefined,
    onFormattingErrorHandler: undefined,
    selectNode: undefined,
    onTypingError: undefined,
    setScrollPosition: undefined,
    saveHtml: undefined,
    getNodeImageIDsFromCache: undefined,
    editAnchor: undefined,
    editLink: undefined,
    editTable: undefined,
    editCodebox: undefined,
    flagEditedNode: undefined,
