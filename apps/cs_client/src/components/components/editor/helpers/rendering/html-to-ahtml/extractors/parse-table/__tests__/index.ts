import {
  ...
  splitTableByRow,
} from '::editor/helpers/rendering/html-to-ahtml/extractors/parse-table/parse-table';
import { testSamples } from '::editor/helpers/rendering/html-to-ahtml/extractors/parse-table/__tests__/__data__';
