import { PersistedFrame } from '::store/ducks/document-cache/helpers/timeline/timeline';
import { TimelinesDict } from '::store/ducks/document-cache/helpers/timeline/timelines-manager';
