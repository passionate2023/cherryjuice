import { calculateTag } from '::helpers/editing/execK/steps/apply-command/apply-tag/calculate-tag';
import {
  genericTests,
  TTagTestSample,
} from '::helpers/editing/execK/steps/apply-command/apply-tag/calculate-tag/__tests__/__data__';
import { specificTests } from '::helpers/editing/execK/steps/apply-command/apply-tag/calculate-tag/__tests__/__data__/specific';
